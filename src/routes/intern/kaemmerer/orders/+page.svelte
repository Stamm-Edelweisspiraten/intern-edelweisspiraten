...
<div class="max-w-6xl mx-auto mt-16 space-y-8">
    ...
    <div class="bg-white border border-gray-200 rounded-2xl shadow-sm p-5 space-y-4">
        <div class="flex items-center justify-between flex-wrap gap-3">
            ...
            <div class="flex items-center gap-3 flex-wrap">
                <form method="post" action="?/reorderCsv">
                    <button type="submit" class="inline-flex items-center gap-2 px-4 py-3 bg-blue-50 hover:bg-blue-100 text-blue-700 rounded-xl font-semibold border border-blue-200 shadow-sm">
    ...
    <div class="bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
        <div class="px-6 py-4 flex items-center justify-between">
            <div>
                <h2 class="text-lg font-semibold text-gray-900">Bestellliste (fehlende Mengen)</h2>
                <p class="text-sm text-gray-600">Fehlmengen bis Mindestbestand, pro Artikel/Größe.</p>
            </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full min-w-full divide-y divide-gray-200 text-sm">
                ...
                {#if reorder.length === 0}
                    <tr>
                        <td colspan="6" class="px-6 py-6 text-center text-sm text-gray-500">Keine Fehlmengen – alle Artikel mindestens auf Zielbestand.</td>
                    </tr>
                {:else}
                    {#each reorder as row}
                        <tr class="hover:bg-gray-50 transition">
