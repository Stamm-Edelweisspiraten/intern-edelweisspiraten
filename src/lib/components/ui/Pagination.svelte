    ...
    <nav class="flex items-center justify-between gap-4 flex-wrap pt-2" aria-label="Seitennavigation">
        ...
        <div class="flex items-center gap-2">
            <a
                ...
                class={`inline-flex items-center gap-2 px-3 py-2 text-sm font-semibold rounded-lg border border-border bg-surface transition ${current <= 1 ? "opacity-40 pointer-events-none" : "hover:bg-surface-muted"}`}
            ...
            <a
                ...
                class={`inline-flex items-center gap-2 px-3 py-2 text-sm font-semibold rounded-lg border border-border bg-surface transition ${current >= pageCount ? "opacity-40 pointer-events-none" : "hover:bg-surface-muted"}`}
